...
useEffect(() => {
  ...
  const getHistoryData = async () => {
    ...
    fetch("https://quizapp-api-c8yt.onrender.com/getUsers.php")
    
    try {
      const response = await fetch(`https://quizapp-api-c8yt.onrender.com/getUsers.php?user_id=${loggedInUser.id}`);
